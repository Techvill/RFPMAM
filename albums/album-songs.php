...
<div class="container">
    <div class="container">
        <div class="col-md-12" id="white-back">
            <h4 class="text-center">VIEW ALBUM SONGS</h4>
            <ul class="pager">
                <li>
            ...
            AlbumsModel::setAlbumID($ID);

            AlbumsAdapter::LoadAlbumSong();

            if (AlbumsModel::getResult() == "TRUE") {

                $Data = json_decode(AlbumsModel::getJSONFEED(), true);

                echo " <table class=\"table table-striped table-bordered table-striped table-condensed\" id='white-back'><thead>
                ...
                echo "<h4 class='text-danger text-center'>There is no album with the ID provided.</h4>";
            }
