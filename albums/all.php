        ...
        <div class="col-md-12">
            ...
            if ($Rows > 0) {
                ...
                foreach ($ResultSet as $feed) {
                    ...
                    <img src='../IMedia/covers/$photo' class='img img-responsive center-block img-circle'>
                ...
                <div class="col-md-12">
                    ...
                    if (isset($_POST['sort'])) {
                            ...
                            case "new":
                                ...
                                if ($Res == "TRUE") {
                                    ...
                                    foreach ($DECODED_JSON as $item) {
                                        ...
                                        <h6 class='text-center'><a class='btn btn-info' href='../artists/view.php?id=$ID'>View Profile</a> </h6>
                                        </div>";
                                    }
                                ...
                                if ($Res == "TRUE") {
                                    ...
                                    foreach ($DECODED_JSON as $item) {
                                        ...
                                        echo " <tr>
                                            ...
                                            <th scope=\"col\"><a href='../artists/view.php?id=$ID'><i class=\"fa fa-user\" aria-hidden=\"true\"></i></a></th>
                        ...
                        if ($Res == "TRUE") {
                            ...
                            echo "<div class='col-md-12'><a href='all.php?type=az' class='btn btn-primary btn-sm'>VIEW ALL</a></div>";
