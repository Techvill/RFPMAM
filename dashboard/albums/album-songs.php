...
<div class="container-fluid">
    <div class="col-md-12 text-center">
        ...
        <div class="col-md-6 col-md-offset-3" id="white-back">
            ...
            $alb = htmlentities($_GET['nm'], ENT_QUOTES, "UTF-8");
            $Artist = htmlentities($_GET['art'], ENT_QUOTES, "UTF-8");
            echo "<h4>SONGS IN THE ALBUM : $alb BY  $Artist</h4><hr/>";

            $ST = "SELECT * FROM songs WHERE alb_id ='$id'";
