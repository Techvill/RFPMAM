...
<div class="container-fluid">
    <div class="col-md-12 text-center">
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            $ST = "SELECT * FROM songs,artists,albums WHERE songs.artist_id=artists.artists_id AND songs.artist_id=albums.artist_id ORDER BY song_id DESC";
            ...
            if ($RS->rowCount() > 0) {
                ...
                foreach ($RS as $feed) {
                    ...
                    echo " <tr>
                        ...
                        <td><a href='album-songs.php?id=$alb_id&nm=$alb&art=$artist''>$alb</a></td>
                        <td>$downloads</td>
                        <td><a href='delete.php?id=$song_id&nm=$name&alb=$alb' >Delete</a></td>
