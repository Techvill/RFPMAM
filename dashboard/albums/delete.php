    ...
    <div class="col-md-12 text-center">
        ...
        <div class="col-md-6 col-md-offset-3" id="white-back">
            ...
            if (!empty($name) && !empty($id)) {
                echo "<p>Are you sure you want to delete <strong>$name</strong> from this $Album?</p>";
                ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <button id="reg-btn" type="submit" name="delete"
                                    class="col-md-12 col-xs-12 btn btn-danger">Delete Song
                            </button>
                        </div>
                    </div>
                </form>
            ...
            if (isset($_POST['delete'])) {
                ...
                $pst = "DELETE FROM songs WHERE song_id='$id'";

                $rst = DBH::getInstance()->CRUD($pst);

                if ($rst->rowCount() > 0) {
                    echo "<h5 class='text-center'>Song was deleted successfully</h5>";
                } else {
                    echo "<h5 class='text-center'>This song was not found in the system, it may have already been deleted.</h5>";
                }
            }
            ?>
