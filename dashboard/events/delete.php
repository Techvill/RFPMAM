...
<div class="container-fluid">
    <div class="col-md-12 text-center">
        ...
        if (isset($_POST['delete'])) {
            ...
            $pst = "DELETE FROM news_events WHERE id='$id'";

            $rst = DBH::getInstance()->CRUD($pst);

            if ($rst->rowCount() > 0) {
                echo "<h5 class='text-center'>Post was deleted successfully</h5>";
            } else {
                echo "<h5 class='text-center'>This post was not found in the system, it may have already been deleted.</h5>";
            }
        }
        ?>
