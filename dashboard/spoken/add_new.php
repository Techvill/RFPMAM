    ...
    <div class="col-md-12 text-center">
        ...
        <div class="col-md-6 col-md-offset-3" id="white-back">
            ...
            if (isset($_POST['register'])) {
                ...
                $CHECK = "SELECT * FROM spoken_word_artists WHERE artist_name ='$Name'";

                $CHECK = DBH::getInstance()->CRUD($CHECK);
                if ($CHECK->rowCount() > 0) {
                    $error[] = "Duplicate entry!!. There is already an artist by that name. Consider entering a different name.";
                }
                ...
                if (empty($error)) {
                    ...
                    if ($move_file_pic) {
                        ...
                        $PST = "INSERT INTO spoken_word_artists(artist_name,pic,bio,facebook,twitter) 
                                VALUES('$Name', '$profile_picture_url','$Bio','$Facebook', '$Twitter')";
                        $RST = DBH::getInstance()->CRUD($PST);

                        if ($RST->rowCount() > 0) {
                            echo "<h5 class='text-info'>Artist was added successfully.</h5>";
                        }
                    }
