...
require_once 'InfinityFramework/MODEL/SpokenxWordModel.php';
...
<head>
    ...
    echo "<meta property='og:url' content='http://www.rfpmam.com/download.php?uid=$id'/>";
...
<form class=\"form-horizontal center-block text-center\" action=\"\" method=\"POST\">
                        ...
                        </button>    <a href='play.php?uid=$id' class=\"btn btn-default\" type=\"\">
