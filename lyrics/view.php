...
<head>
    ...
    <title><?php echo "Song Lyrics : $Name | RFP Music and Arts " ?></title>

    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <?php

    echo "<link href='../IMedia/art/$Photo' rel='icon' type='image/png'/>";
    ...
    <meta property="og:title"
          content="<?php echo "View Song Lyrics : $Name  | RFP Music and Arts " ?>"/>
    <meta property="og:description"
          content="<?php echo "Song Lyrics : $Name | RFP Music and Arts " ?>"/>
    <?php

    echo "<meta property='og:image' content='http://www.rfpmam.com/IMedia/art/$Photo'/>";
    echo "<meta property='og:url' content='http://www.rfpmam.com/lyrics/view.php?id=$ID'/>";
        ...
        if (Lyrics::getResult() == "TRUE") {
            ...
            foreach ($Decode as $item) {
                ...
                echo "<div class='col-md-8 col-md-offset-2' >
                    <div id='white-back'>
                       <img src='../IMedia/art/$Photo' id='art' class='img img-responsive center-block img-circle'>
                       <h3 class='text-center'><a class='text-center' href='../artists/view.php?id=$AID'>$artist</a> </h3>
