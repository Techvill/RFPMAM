    ...
    <div class="col-md-12">
        ...
        <div class="col-md-12" id="white-back">
            ...
            <div class="col-md-12 col-xs-12">
                ...
                $Letter = htmlentities($_GET['id'], ENT_QUOTES, "UTF-8");

                if (!empty($Letter)) {


                    SongsAdapter::FetchSpecific($Letter);
                    ...
                    if ($FeedResponse == "TRUE") {
                        ...
                        <th scope=\"col\"><a href='../DL/songs/$song_url'><i class=\"fa fa-play\" aria-hidden=\"true\"></i></a></th>
                        <th scope=\"col\">
                        ...
                        echo "<h4 class='text-center text-danger'>There are no songs that start with the letter {$Letter}!</h4>";
                    }
