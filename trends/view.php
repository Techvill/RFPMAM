...
<head>
    ...
    echo "<meta property='og:url' content='http://www.rfpmam.com/trends/view.php?id=$ArtistID'/>";
            ...
            if (empty($ArtistID)) {
                ...
                if ($RES == "TRUE") {
                    ...
                    foreach ($json_a as $feed) {
                        ...
                        echo " <img src='../IMedia/artists_pics/$photo' id='profile-pic' class='img img-responsive center-block'>
                                <h5 class='text-center'><strong>$name</strong></h5>
                                <pre class='text-justify'>$bio</pre><hr/>
                             ";
    ...
    <div class="col-md-6" id="white-back">
        <div class="col-md-12">
            ...
            if (empty($ArtistID)) {
              ...
              <a href='download-alb.php?uid=$alb_id'><span><i class=\"fa fa-download\" aria-hidden=\"true\"></i></span></a>
                    </h6>
